...
> >$$\left[\text{{Probability}} = \frac{{\text{{Number of arrangements with 4 given books together}}}}{{\text{{Total number of possible arrangements}}}} = \frac{{8! \times 4!}}{{10!}}\right]$$\
> >Therefore, the probability of 4 given books being side by side is $$\frac{{8! \times 4!}}{{10!}}$$.
{: .solution}
{: .challenge}
